...
training_data = marmot.Dataset(training_data[0], training_data[1], minibatch_size = 64)
validation_data = marmot.Dataset(validation_data[0], validation_data[1], minibatch_size = 64)
